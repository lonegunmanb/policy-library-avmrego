...
deny_app_service_enable_failed_request contains reason if {
...
deny_linux_web_app_enable_failed_request contains reason if {
...
deny_windows_web_app_enable_failed_request contains reason if {
