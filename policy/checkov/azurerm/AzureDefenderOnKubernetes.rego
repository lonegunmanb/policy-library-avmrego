...
valid_azurerm_security_center_subscription_pricing_configuration(resource) if {
...
deny_CKV_AZURE_85 contains reason if {
    ...
    not valid_azurerm_security_center_subscription_pricing_configuration(resource)
